    ...
    <div id="mainContent">
      ...
      <div class="textarea">
        ...
        <input type="hidden" name="writeNum" value="${writeNum }">
          ...
          <input type="text" id="title" name="title" value="${title}" required="required">
          <br><br>
          <!-- 글 내용 적을 곳 -->
          <p class="subsubtitle">본문</p>
          <textarea name="content" id="content" cols="83" rows="30" required="required">${content}</textarea>
          <br>
<!--           <input type="file"> -->
          <div class="oncenter">										
